...
<div class="row" style="margin-top: 1em;">
    ...
    <div class="col-md-4" style="border-style: dotted; border-color: red; margin-left:1em">
        ...
        <div class="row">
            ...
            <div class="col col-md-4">
                ...
                <input type="text" class="form-control" name="mes" id="mes" placeholder="MM" required>
            ...
            <div class="col col-md-4">
                ...
                <input type="text" class="form-control" name="annio" id="annio" placeholder="YYYY" required>
            </div>
    ...
    <div class="col-md-2">
        <a href=""> <img src="/public/img/actualizar.png" width="50px" alt="actualizar"></a>
    </div>
</div>
<!-- boton buscar -->
</form>
