        ...
        <div class="col col-md-3 offset-md-1">
            ...
            <form action="?controlador=user&accion=registrar_metodo_pago" method="post">
                <div class="form-group">
                    ...
                    <input name="propietario" type="text" class="form-control" id="propietario" aria-describedby="nombre_p">
                </div>
                <div class="form-group">
                    <label for="numero_tarjeta">Número de tarjeta</label>
                    <input name="numero_tarjeta" type="number" min="1" class="form-control" id="numero_tarjeta" aria-describedby="numero_t">
                    <small id="numero_t" class="form-text text-muted">No vamos a compartir esta información.</small>
                </div>
                <div class="form-group">
                    <label for="fecha_vencimiento">Fecha de vencimiento</label>
                    <input name="fecha_vencimiento" type="date" class="form-control" id="fecha_vencimiento">
                </div>
                <div class="form-group">
                    <label for="cvv">CVV</label>
                    <input name="cvv" type="number" min="1" class="form-control" id="cvv">
                </div>
            ...
            <ul class="list-group">
                ...
                ?>
                        <li class="list-group-item text-left mx-2" style="margin-bottom: 1em;">
                            ...
                            <p>NUMERO: <?php echo $item['numero_tarjeta'] ?></p>
                            <p>FECHA.VEN: <?php echo $item['fecha_vencimiento'] ?></p>
